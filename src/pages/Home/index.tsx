                        ...
                        {meta ? (
                            <>
                                <Text style={styles.title}>
                                    Última atualização: {meta ? meta.dataAtualizacao : '--/--/----'} as{' '}
                                ...
                                <Divider />
                                <ProgressBar
                                    title={`Base carteira ${meta.atendimentoPercentual.toFixed(2)} %`}
                            ...
                            <Text style={styles.subtitle}>
                                Você ainda não possui apuração calculada, verifique com seu gerente.
                            </Text>
                        )}
                    </Container>
                </View>
