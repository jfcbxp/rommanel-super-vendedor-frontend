    ...
    return (
        <View style={styles.container}>
            <View style={{ marginBottom: 32 }}>
                <Image source={require('../../assets/ROMMANEL_BUTTLERFLY.png')} style={{ width: 85, height: 77 }} />
            ...
            <View style={{ marginBottom: 40 }}>
                ...
                <Button title="ENTRAR" disabled={code.length == 6 && password ? false : true} onPress={signIn} />
            </View>
